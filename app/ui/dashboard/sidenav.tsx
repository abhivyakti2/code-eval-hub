  ...
  return (
    <div className="flex h-full flex-col px-3 py-4 md:px-2">
      ...
      <div className="flex grow min-h-0 flex-row justify-start space-x-2 md:flex-col md:space-x-0 md:space-y-2">
        <Link
          href="/dashboard"
          className="flex h-[48px] items-center gap-2 rounded-md border border-slate-800 bg-slate-900/70 px-3 text-sm font-medium text-slate-200 hover:border-cyan-500/40 hover:bg-slate-800 hover:text-cyan-300 md:flex-none md:p-2"
        >
        ...
        <div className="hidden min-h-0 w-full flex-1 rounded-md border border-slate-800 bg-slate-900/70 md:flex md:flex-col">
        ...
        <form action={logout}>
          <button className="flex h-[48px] w-full grow items-center justify-center gap-2 rounded-md border border-slate-800 bg-slate-900/70 p-3 text-sm font-medium text-slate-200 hover:border-cyan-500/40 hover:bg-slate-800 hover:text-cyan-300 md:flex-none md:justify-start md:p-2 md:px-3">
